...
- **公開済み**：[PR #164](https://github.com/kankidoi2-byte/monster-rpg-ver8/pull/164)、統合commit `44552c5658a3029c8ac4ede11c04f5e419041444`。世界地図は統合・公開済み。PR #174・#176および#175（d2e6fb123d544b5f525dff68692064bc16d2efe6）も統合・公開済み。#175の実装は乱入・三つ巴の3不具合修正で、数値調整案の採用ではない。19マップ刷新#212、全景鑑賞#213、画像参照統一#215も公開済み。世界の狭間はAlfaのみ。
