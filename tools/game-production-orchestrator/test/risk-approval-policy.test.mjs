...
assert.equal(progress.current_cycle, 0);
assert.equal(progress.current_phase, 0);
assert.equal(progress.next_cycle, 1);
...
assert.equal(roadmap.includes('Cycle 1 / Phase 1'), true);
