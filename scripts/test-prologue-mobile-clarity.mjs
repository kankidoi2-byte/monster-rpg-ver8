...
assert.ok(index.includes('tutorial-replay-scope-1-tutorial-replay-retired-1"></script>'),'the mobile browser must fetch the replay-retired tutorial logic');
assert.ok(index.includes('diagnostics-screen-1-tutorial-replay-battle-fix-1-tutorial-growth-guidance-1-tutorial-replay-scope-1-tutorial-replay-retired-1"></script>'),'the mobile browser must fetch the replay retirement notice');
