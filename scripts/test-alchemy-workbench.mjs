...
assert(alchemy.includes('toggleAlchemyGuide(false)'), 'Lumina guide cannot be closed');
...
console.log('Alchemy workbench validation passed (materials, quantities, optional catalyst, hidden result, Lumina guide, and short-screen layout).');
