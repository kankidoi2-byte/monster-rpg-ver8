...
assert.equal(ids.length,90,'the reduced prologue includes the world-map rescue route and one monster growth-tab action');
...
console.log('Prologue step reduction validation passed (130 -> 90 (including world-map rescue and growth tab), old-save redirects, essential operations, merged explanations, and prior mobile fixes).');
