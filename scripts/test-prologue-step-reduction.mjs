...
assert.ok(index.includes('tutorial-replay-scope-1-tutorial-replay-retired-1-tutorial-skill-button-layout-1-prologue-story-mode-1"></script>'),'the browser must fetch the counterless tutorial logic with normal-position skill actions');
