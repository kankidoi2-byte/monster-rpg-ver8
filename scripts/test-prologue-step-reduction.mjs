...
assert.equal(ids.length,97,'the reduced prologue includes rescue, Royal Capital facility routes, and one monster growth-tab action');
...
console.log('Prologue step reduction validation passed (130 -> 97 (including world-map rescue, Royal Capital facilities, and growth tab), old-save redirects, essential operations, merged explanations, and prior mobile fixes).');
