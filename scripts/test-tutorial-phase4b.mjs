...
assert.ok(index.includes('js/tutorial.js?v=prologue-rescue-stability-1')&&index.includes('prologue-elna-rescue-1'),'changed encounter and battle scripts must have fresh cache keys');
