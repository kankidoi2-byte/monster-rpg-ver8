...
let started=null,prepared=0,registered=null,available=true,eventList=[],party=[{uid:'p'}],discovered=[],saveCount=0;
...
const list={classList:{add(){}},innerHTML:'',querySelector(){return null;},contains(){return true;}};
const context={
  MAPS:maps,HUNT_DIFFICULTIES:difficulties,Math,Map,Object,String,alert(){},document:{getElementById(){return list;}},
  ...
  startChosenBattle:(...args)=>{started=args;}
};
...
context.renderWorldMap(list);eventList=[{key:'crisis',mapId:'starsea',title:'危機',kind:'crisis'}];
