...
assert.match(index, /js\/tutorial\.js\?v=[^"]*tutorial-replay-scope-1-tutorial-replay-retired-1-tutorial-skill-button-layout-1-prologue-story-mode-1-prologue-episode-break-fix-1[^"]*"><\/script>/, 'tutorial JS cache key must retain episode-break fixes and allow newer revisions');
