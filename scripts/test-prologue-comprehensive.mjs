...
assert.ok(index.includes('prologue-request-panel-fix-1-prologue-expedition-target-portrait-policy-1-prologue-continuity-1"></script>'),'tutorial JS cache key must be refreshed');
