...
assert.ok(index.includes('prologue-request-panel-fix-1-prologue-expedition-target-portrait-policy-1-prologue-continuity-1-prologue-mobile-clarity-1-prologue-step-reduction-1-prologue-progress-order-1"></script>'),'tutorial JS cache key must be refreshed');
