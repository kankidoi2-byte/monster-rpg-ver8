...
assert.ok(index.includes('js/tutorial.js?v=tutorial-battle-start-fix-1')&&index.includes('tutorial-battle-start-fix-1'),'changed browser scripts must have refreshed cache keys');
