...
assert.ok(index.includes('js/tutorial.js?v=prologue-gnosis-intro-1')&&index.includes('prologue-gnosis-intro-1'),'changed browser scripts must have refreshed cache keys');
