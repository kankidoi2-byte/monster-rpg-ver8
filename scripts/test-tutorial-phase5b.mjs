...
assert.ok(index.includes('js/tutorial.js?v=prologue-elna-encounter-1')&&index.includes('prologue-elna-encounter-1'),'changed browser scripts must have refreshed cache keys');
