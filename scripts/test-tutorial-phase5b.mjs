...
assert.ok(index.includes('js/tutorial.js?v=prologue-step-modes-1')&&index.includes('prologue-step-modes-1'),'changed browser scripts must have refreshed cache keys');
