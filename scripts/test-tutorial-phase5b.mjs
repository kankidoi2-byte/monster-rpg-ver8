...
assert.ok(index.includes('js/tutorial.js?v=tutorial-android-flow-fix-1')&&index.includes('tutorial-android-flow-fix-1'),'changed browser scripts must have refreshed cache keys');
