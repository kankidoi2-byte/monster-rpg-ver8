...
assert.ok(index.includes('js/tutorial.js?v=tutorial-action-guidance-1')&&index.includes('tutorial-action-guidance-1'),'changed browser scripts must have refreshed cache keys');
