...
const requiredMainOrder=[
  'intro_gnosis','gnosis_call_2','gnosis_call_3','gnosis_reveal','gnosis_name','gnosis_contract_power','gnosis_descent','elna_encounter','gnosis_rescue_alert','gnosis_starter_contracts','starter_contracts_received','elna_guest_join','elna_rescue_start','battle_enemy','battle_skill','battle_free','elna_rescue_complete',
...
assert.ok(index.includes('js/tutorial.js?v=prologue-elna-encounter-1'),'the integrated tutorial engine cache key is missing');
