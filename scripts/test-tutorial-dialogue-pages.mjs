...
assert.equal(run('tutorialFlowSteps(TUTORIAL_MAIN_FLOW_ID).length'),102,'registered production flow includes the final party swap and Freigal expedition setup');
