...
const MAPS = [
  ...
  {id:'golden_land', name:'黄金郷', image:MAPIMG.golden_land,
...
/* ===== モンスターデータ ===== */
const M = [
  {id:'freigal',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'freigal',no:1,name:'フレイガル',rarity:'★',types:['fire'],
  ...
  {id:'freiwolf',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'freiwolf',no:2,name:'フレイウルフ',rarity:'★★',types:['fire'],
  ...
  {id:'aquaron',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'aquaron',no:3,name:'アクアロン',rarity:'★',types:['water','dragon'],
  ...
  {id:'highaquaron',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'highaquaron',no:4,name:'ハイアクアロン',rarity:'★★',types:['water','dragon'],
  ...
  {id:'shenhairon',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'shenhairon',no:5,name:'シェンハイロン',rarity:'★★★',types:['water','dragon'],
  ...
  {id:'tienhairon',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'tienhairon',no:6,name:'ティエンハイロン',rarity:'★★★',types:['water','dragon'],
  ...
  {id:'grassbeat',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'grassbeat',no:7,name:'グラスビート',rarity:'★',types:['grass'],
  ...
  {id:'thornbeat',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'thornbeat',no:8,name:'ソーンビート',rarity:'★★',types:['grass'],
  ...
  {id:'granbeat',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'granbeat',no:9,name:'グランビート',rarity:'★★★',types:['grass'],
  ...
  {id:'rikasheef',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'rikasheef',no:32,name:'リカシーフ',rarity:'★',types:['grass'],
  ...
  {id:'seralphia',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'seralphia',no:33,name:'セラルフィア',rarity:'★★★',types:['grass'],
  ...
  {id:'nightmare',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'nightmare',no:10,name:'ナイトメア',rarity:'★★',types:['dark'],
  ...
  {id:'volteck',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'volteck',no:11,name:'ボルテック',rarity:'★',types:['thunder','wind'],
  ...
  {id:'spaquinn',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'spaquinn',no:12,name:'スパクイン',rarity:'★★',types:['thunder','wind'],
  ...
  {id:'voltax',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'voltax',no:13,name:'ボルタックス',rarity:'★★★',types:['thunder','wind'],
  ...
  {id:'icegolem',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'icegolem',no:15,name:'アイスゴーレム',rarity:'★★',types:['water'],
  ...
  {id:'proto_icegolem',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'proto_icegolem',no:14,name:'プロトアイスゴーレム',rarity:'★★',types:['water'],
  ...
  {id:'hikari',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'goddess',no:16,name:'光の女神',rarity:'★★★★',types:['light'],
  ...
  {id:'nemes',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'nemes',no:17,name:'ネメス',rarity:'★★',types:['star','dragon'],
  ...
  {id:'nemesia',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'nemesia',no:18,name:'ネメシア',rarity:'★★★',types:['star','dragon'],
  ...
  {id:'nemesion',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'nemesion',no:19,name:'ネメシオン',rarity:'★★★★',types:['star','dragon'],
  ...
  {id:'elna_beginner',entityKind:'character',eligibility:{"contract":false,"alchemyCatalyst":false,"alchemySuccess":false,"alchemyFailure":false},imgKey:'elna',no:21,name:'初級剣士エルナ',rarity:'★',types:['normal'],unitType:'character',characterNo:1,contractable:false,
  ...
  {id:'elna_middle',entityKind:'character',eligibility:{"contract":false,"alchemyCatalyst":false,"alchemySuccess":false,"alchemyFailure":false},imgKey:'elnaMiddle',no:22,name:'中級剣士エルナ',rarity:'★★',types:['normal'],unitType:'character',characterNo:2,contractable:false,
  ...
  {id:'elna_advanced',entityKind:'character',eligibility:{"contract":false,"alchemyCatalyst":false,"alchemySuccess":false,"alchemyFailure":false},imgKey:'elnaAdvanced',no:23,name:'上級剣士エルナ',rarity:'★★★',types:['normal'],unitType:'character',characterNo:3,contractable:false,
  ...
  {id:'suiren',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'suiren',no:24,name:'水の精霊スイレン',rarity:'★★',types:['water'],
  ...
  {id:'elna_water',entityKind:'character',eligibility:{"contract":false,"alchemyCatalyst":false,"alchemySuccess":false,"alchemyFailure":false},imgKey:'elnaWater',no:25,name:'流水の剣士エルナ',rarity:'★★★★',types:['water','normal'],unitType:'character',characterNo:4,contractable:false,
  ...
  {id:'slime',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'slime',no:26,name:'スライム',rarity:'★',types:['normal'],
  ...
  {id:'slime_gold',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'slime_gold',no:27,name:'スライムゴールド',rarity:'★★',types:['normal'],
  ...
  {id:'goblin',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'goblin',no:28,name:'ゴブリン',rarity:'★',types:['normal'],
  ...
  {id:'volmoog',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'volmoog',no:34,name:'ボルモーグ',rarity:'★★',types:['thunder'],
  ...
  {id:'gran_volmoog',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'gran_volmoog',no:35,name:'グランボルモーグ',rarity:'★★★',types:['thunder'],
  ...
  {id:'orcana',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'orcana',no:42,name:'オルカーナ',rarity:'★★',types:['water'],
  ...
  {id:'orca_stream',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'orca_stream',no:43,name:'オルカストリーム',rarity:'★★★',types:['water'],
  ...
  {id:'orca_abyss',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'orca_abyss',no:44,name:'オルカアビス',rarity:'★★★★',types:['water'],
  ...
  {id:'tsubaki',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'tsubaki',no:45,name:'炎の精霊ツバキ',rarity:'★★',types:['fire'],
  ...
  {id:'elna_kaen',entityKind:'character',eligibility:{"contract":false,"alchemyCatalyst":false,"alchemySuccess":false,"alchemyFailure":false},imgKey:'elnaKaen',no:46,name:'華炎の剣士エルナ',rarity:'★★★★',types:['fire','normal'],unitType:'character',characterNo:5,contractable:false,
