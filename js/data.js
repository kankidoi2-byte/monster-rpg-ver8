...
const IMG={
  ...
  slime:"images/monsters/slime_20260920.webp",
  granbeat:"images/monsters/granbeat_20260919.webp",
  thornbeat:"images/monsters/thornbeat_20260919.webp",
  elnaWater:"images/monsters/elna_water.webp",
  suiren:"images/monsters/suiren_20260920.webp",
  ...
  freiwolf:"images/monsters/freiwolf_20260919.webp",
  freigal:"images/monsters/freigal_20260919.webp",
  ...
  ignaros:'images/monsters/ignaros_20260920.webp',
...
/* ===== モンスターデータ ===== */
const M = [
  {id:'freigal',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'freigal',no:1,dexNo:1,name:'フレイガル',rarity:'★',types:['fire'],huntLevels:{normal:8},
  ...
  {id:'freiwolf',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'freiwolf',no:2,dexNo:2,name:'フレイウルフ',rarity:'★★',types:['fire'],huntLevels:{normal:20,hard:46},
  ...
  {id:'aquaron',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'aquaron',no:3,dexNo:3,name:'アクアロン',rarity:'★',types:['water','dragon'],huntLevels:{normal:7},
  ...
  {id:'highaquaron',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'highaquaron',no:4,dexNo:4,name:'ハイアクアロン',rarity:'★★',types:['water','dragon'],huntLevels:{normal:20,hard:48},
  ...
  {id:'shenhairon',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'shenhairon',no:5,dexNo:5,name:'シェンハイロン',rarity:'★★★',types:['water','dragon'],huntLevels:{normal:44,hard:74},
  ...
  {id:'tienhairon',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'tienhairon',no:6,dexNo:6,name:'ティエンハイロン',rarity:'★★★',types:['water','dragon'],huntLevels:{normal:44,hard:74},
  ...
  {id:'grassbeat',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'grassbeat',no:7,dexNo:7,name:'グラスビート',rarity:'★',types:['grass'],huntLevels:{normal:6},
  ...
  {id:'thornbeat',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'thornbeat',no:8,dexNo:8,name:'ソーンビート',rarity:'★★',types:['grass'],huntLevels:{normal:19,hard:47},
  ...
  {id:'granbeat',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'granbeat',no:9,dexNo:9,name:'グランビート',rarity:'★★★',types:['grass'],huntLevels:{normal:42,hard:72},
  ...
  {id:'rikasheef',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'rikasheef',no:32,dexNo:10,name:'リカシーフ',rarity:'★',types:['grass'],huntLevels:{normal:10},
  ...
  {id:'volteck',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'volteck',no:11,dexNo:12,name:'ボルテック',rarity:'★',types:['thunder','wind'],huntLevels:{normal:9},
  ...
  {id:'spaquinn',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'spaquinn',no:12,dexNo:13,name:'スパクイン',rarity:'★★',types:['thunder','wind'],huntLevels:{normal:21,hard:50},
  ...
  {id:'voltax',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'voltax',no:13,dexNo:14,name:'ボルタックス',rarity:'★★★',types:['thunder','wind'],huntLevels:{normal:43,hard:73},
  ...
  {id:'icegolem',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'icegolem',no:15,dexNo:36,name:'アイスゴーレム',rarity:'★★',types:['water'],huntLevels:{normal:26,hard:56},
  ...
  {id:'proto_icegolem',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'proto_icegolem',no:14,dexNo:35,name:'ゴーレム',rarity:'★★',types:['normal'],huntLevels:{normal:18,hard:44},
  ...
  {id:'nemes',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'nemes',no:17,dexNo:41,name:'ネメス',rarity:'★★',types:['star','dragon'],huntLevels:{normal:24,hard:52},
  ...
  {id:'nemesia',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'nemesia',no:18,dexNo:42,name:'ネメシア',rarity:'★★★',types:['star','dragon'],huntLevels:{normal:48,hard:78},
  ...
  {id:'nemesion',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'nemesion',no:19,dexNo:43,name:'ネメシオン',rarity:'★★★★',types:['star','dragon'],huntLevels:{hard:92},
  ...
  {id:'doom_nemesion',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'doomNemesion',no:20,dexNo:44,name:'滅亡の星 ネメシオン',rarity:'★★★★★',types:['star','dragon'],
  ...
  {id:'suiren',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'suiren',no:24,dexNo:34,name:'水の精霊スイレン',rarity:'★★',types:['water'],huntLevels:{normal:27,hard:58},
  ...
  {id:'slime',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'slime',no:26,dexNo:29,name:'スライム',rarity:'★',types:['normal'],huntLevels:{normal:5},
  ...
  {id:'slime_gold',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'slime_gold',no:27,dexNo:30,name:'スライムゴールド',rarity:'★★',types:['normal'],huntLevels:{normal:30,hard:60},
  ...
  {id:'goblin',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'goblin',no:28,dexNo:31,name:'ゴブリン',rarity:'★',types:['normal'],huntLevels:{normal:7},
  ...
  {id:'false_dragon_alfa',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'false_dragon_alfa',no:29,dexNo:45,name:'偽竜 code:alfa',rarity:'★★★★★',types:['normal','light'],
  ...
  {id:'gran_volmoog',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'gran_volmoog',no:35,dexNo:28,name:'グランボルモーグ',rarity:'★★★',types:['thunder'],huntLevels:{normal:45,hard:75},
  ...
  {id:'orcana',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'orcana',no:42,dexNo:24,name:'オルカーナ',rarity:'★★',types:['water'],huntLevels:{normal:22,hard:50},
  ...
  {id:'orca_stream',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'orca_stream',no:43,dexNo:25,name:'オルカストリーム',rarity:'★★★',types:['water'],huntLevels:{normal:47,hard:77},
  ...
  {id:'orca_abyss',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'orca_abyss',no:44,dexNo:26,name:'オルカアビス',rarity:'★★★★',types:['water'],huntLevels:{hard:90},
  ...
  {id:'tsubaki',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'tsubaki',no:45,dexNo:33,name:'炎の精霊ツバキ',rarity:'★★',types:['fire'],huntLevels:{normal:28,hard:58},
  ...
  {id:'sylphin',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'sylphin',no:51,dexNo:15,name:'シルフィン',rarity:'★',types:['wind'],huntLevels:{normal:8},
  ...
  {id:'zephyray',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'zephyray',no:52,dexNo:16,name:'ゼファーレイ',rarity:'★★',types:['wind'],huntLevels:{normal:19,hard:47},
  ...
  {id:'tempestray',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'tempestray',no:53,dexNo:17,name:'テンペストレイ',rarity:'★★★',types:['wind'],huntLevels:{normal:45,hard:75},
  ...
  {id:'ignaros',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'ignaros',no:54,dexNo:32,name:'イグナロス',rarity:'★★',types:['fire'],huntLevels:{normal:25,hard:54},
  ...
  {id:'nocle',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'nocle',no:55,dexNo:21,name:'ノクル',rarity:'★',types:['dark','dragon'],huntLevels:{normal:12},
  ...
  {id:'noclaid',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'noclaid',no:56,dexNo:22,name:'ノクレイド',rarity:'★★',types:['dark','dragon'],huntLevels:{normal:24,hard:52},
  ...
  {id:'noxvelg',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'noxvelg',no:57,dexNo:23,name:'ノクスヴェルグ',rarity:'★★★',types:['dark','dragon'],huntLevels:{normal:50,hard:80},
  ...
  {id:'luxseed',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'luxseed',no:58,dexNo:18,name:'ルクシード',rarity:'★',types:['light','dragon'],huntLevels:{normal:12},
  ...
  {id:'luxiard',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":false},imgKey:'luxiard',no:59,dexNo:19,name:'ルクシアード',rarity:'★★',types:['light','dragon'],huntLevels:{normal:24,hard:52},
  ...
  {id:'lux_galdion',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'lux_galdion',no:60,dexNo:20,name:'ルクスガルディオン',rarity:'★★★',types:['light','dragon'],
  ...
  {id:'astralepis',entityKind:'monster',eligibility:{"contract":true,"alchemyCatalyst":true,"alchemySuccess":false,"alchemyFailure":true},imgKey:'astralepis',no:61,dexNo:38,name:'アストラレピス',rarity:'★★',types:['star'],huntLevels:{normal:22,hard:50},
...
const ITEM_IMG = {
  metal_ore: 'images/items/metal_ore_art_v1.webp',
  fine_metal_ore: 'images/items/fine_metal_ore_art_v1.webp',
  unstable_alchemy_matter: 'images/items/unstable_alchemy_matter_art_v1.webp',
  fine_unstable_alchemy_matter: 'images/items/fine_unstable_alchemy_matter_art_v1.webp',
  monster_bone: 'images/items/monster_bone_art_v1.webp',
  fine_monster_bone: 'images/items/fine_monster_bone_art_v1.webp',
  magic_crystal: 'images/items/magic_crystal_art_v1.webp',
  fine_magic_crystal: 'images/items/fine_magic_crystal_art_v1.webp',
  potion: 'images/items/potion_art_v1.webp',
  upper_potion: 'images/items/upper_potion_art_v1.webp',
  attack_potion: 'images/items/attack_potion_art_v1.webp',
