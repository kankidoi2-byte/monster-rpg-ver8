...
const GAME_NOTICES = Object.freeze([
  Object.freeze({id:'20260913-battle-sfx',date:'2026-09-13',category:'update',title:'命中・回復・勝利に効果音を追加',body:'通常命中と弱点命中を音で区別でき、HPが実際に回復したときや最後の敵に勝利したときにも短い音が鳴ります。ホームと戦闘画面の「効果音」から音量・ミュートを変更し、4種類を試聴できます。設定はこの端末のブラウザに保存されます。'}),
