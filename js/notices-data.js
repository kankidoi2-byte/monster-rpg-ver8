...
const GAME_NOTICES = Object.freeze([
  Object.freeze({
    ...
    title:'序章の会話を更新しました',
    body:'目覚めからエルナとの契約、王都への道中とステラとの出会いまでの会話を更新しました。ステラ本人との戦闘を追加し、好きな技で挑めるようにしました。学園への追跡、ルミナとの初回錬成、ガルドラ誕生後の工房での別れも更新しました。ガルドラが飛び寄ったり、噛みついたりする姿も表示されます。最後はガルドラ・アクアロン・エルナを編成し、控えのフレイガルを短距離遠征へ送って、その帰還を待たず冒険へ進めます。同じ場面の会話は、話者に合わせて読み進められます。横画面で案内が世界地図や図鑑の操作ボタンに重ならないよう改善しました。'
  }),
  Object.freeze({
  ...
  Object.freeze({
    id:'20260906-safira-dex-art',date:'2026-09-06',category:'update',
    title:'サフィラ系統のイラストを追加',
    body:'キャラクター図鑑No.27〜29に、隊商槍士サフィラ・砂嵐槍士サフィラ・紅砂護商長サフィラのイラストを追加しました。詳細画面で3段階の姿を確認できます。現在は登場予定です。'
  }),
  Object.freeze({
    id:'20260906-bordo-dex-art',date:'2026-09-06',category:'update',
    title:'ボルド系統のイラストを追加',
    body:'キャラクター図鑑No.30〜32に、新入りのボルド・熟練のボルド・司厨長ボルドのイラストを追加しました。詳細画面で3段階の姿を確認できます。現在は登場予定です。'
  }),
  Object.freeze({
    id:'20260906-remnes-dex-art',date:'2026-09-06',category:'update',
    title:'レムネス系統のイラストを追加',
    body:'キャラクター図鑑No.39〜41に、レムネス・記憶騎装レムネス・星鎧のレムナントのイラストを追加しました。図鑑の詳細画面で3段階の姿を確認できます。現在は登場予定です。'
  }),
  Object.freeze({
    id:'20260906-prologue-character-dex-slots',date:'2026-09-06',category:'update',
    title:'序章のキャラクター図鑑を50枠に拡張',
    body:'新たな12系統・36形態の図鑑枠を追加しました。名前・属性・成長段階を確認できます。「登場予定」のキャラクターは、今後ガチャや育成で加入する予定です。現在は入手・対戦できません。'
  }),
  Object.freeze({
  ...
  Object.freeze({
    id:'20260906-favorite-home-frame',date:'2026-09-06',category:'update',
    title:'お気に入りに金色のフレームを追加',
    body:'ホームのお気に入り画像に、金色のフレームを付けました。仲間の名前も濃い文字と明るい名札で読みやすくしました。'
  }),
  Object.freeze({
