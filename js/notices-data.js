...
const GAME_NOTICES = Object.freeze([
  Object.freeze({id:'20260920-map-art-renewal',date:'2026-09-20',category:'update',title:'全マップの景観イラストを刷新しました',body:'草原から黄金郷まで、現在登場する全19マップの景観イラストを新しくしました。戦闘画面、タイトル画面、マップ図鑑、モンスター図鑑の出現場所で各地の新しい景観を確認できます。マップの出現条件・敵・難易度・報酬に変更はありません。'}),
  ...
  Object.freeze({id:'20260920-rikasheef-seralphia-art',date:'2026-09-20',category:'update',title:'リカシーフとセラルフィアのイラストを更新しました',body:'図鑑・編成・戦闘などで表示されるリカシーフとセラルフィアのイラストを更新しました。能力・技・進化条件に変更はありません。'}),
  Object.freeze({id:'20260920-slime-gold-goblin-art',date:'2026-09-20',category:'update',title:'スライムたちのイラストを更新しました',body:'図鑑・編成・戦闘などで表示されるスライム、スライムゴールド、ゴブリンのイラストを更新しました。能力・技・出現設定に変更はありません。'}),
  ...
  Object.freeze({
    ...
    title:'序章の会話を更新しました',
    body:'目覚めからエルナとの契約、王都への道中とステラとの出会いまでの会話を更新しました。ステラ本人との戦闘を追加し、好きな技で挑めるようにしました。学園への追跡、ルミナとの初回錬成、ガルドラ誕生後の工房での別れも更新しました。ガルドラが飛び寄ったり、噛みついたりする姿も表示されます。最後はガルドラ・アクアロン・エルナを編成し、控えのフレイガルを短距離遠征へ送って、その帰還を待たず冒険へ進めます。序章を全体スキップした場合も、同じ3体を編成して自由行動へ移ります。同じ場面の会話は、話者に合わせて読み進められます。横画面で案内が世界地図や図鑑の操作ボタンに重ならないよう改善しました。'
  }),
  Object.freeze({
