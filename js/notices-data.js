...
const GAME_NOTICES = Object.freeze([
  Object.freeze({
    ...
    title:'序章の会話を更新しました',
    body:'目覚めからエルナとの契約、王都への道中とステラとの出会いまでの会話を更新しました。ステラ本人との戦闘を追加し、好きな技で挑めるようにしました。学園への追跡と工房での会話も更新しました。同じ場面の会話は、話者に合わせて読み進められます。横画面で案内が世界地図や図鑑の操作ボタンに重ならないよう改善しました。'
  }),
  Object.freeze({
